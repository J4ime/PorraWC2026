...
object MatchScheduleProvider {
    ...
    private fun buildHardcodedSchedule(): Map<Int, MatchSchedule> {
        ...
        data[73] = MatchSchedule(73, "2026-06-28T21:00:00", "RTVE", "2º Grupo A", "2º Grupo B")
        data[74] = MatchSchedule(74, "2026-06-29T20:30:00", "RTVE", "1º Grupo E", "3º (A/B/C/D/F)")
        data[75] = MatchSchedule(75, "2026-06-30T03:00:00", "DAZN", "1º Grupo F", "2º Grupo C")
        data[76] = MatchSchedule(76, "2026-06-30T06:00:00", "DAZN", "1º Grupo C", "2º Grupo F")
        data[77] = MatchSchedule(77, "2026-06-30T21:00:00", "RTVE", "1º Grupo I", "3º (C/D/F/G/H)")
        data[78] = MatchSchedule(78, "2026-07-01T06:00:00", "DAZN", "2º Grupo E", "2º Grupo I")
        data[79] = MatchSchedule(79, "2026-07-01T03:00:00", "DAZN", "1º Grupo A", "3º (C/E/F/H/I)")
        data[80] = MatchSchedule(80, "2026-07-01T16:00:00", "RTVE", "1º Grupo L", "3º (E/H/I/J/K)")
        data[81] = MatchSchedule(81, "2026-07-02T03:00:00", "RTVE", "1º Grupo D", "3º (B/E/F/I/J)")
        data[82] = MatchSchedule(82, "2026-07-01T23:00:00", "RTVE", "1º Grupo G", "3º (A/E/H/I/J)")
        data[83] = MatchSchedule(83, "2026-07-02T23:00:00", "RTVE", "2º Grupo K", "2º Grupo L")
        data[84] = MatchSchedule(84, "2026-07-02T22:00:00", "RTVE", "1º Grupo H", "2º Grupo J")
        data[85] = MatchSchedule(85, "2026-07-03T06:00:00", "DAZN", "1º Grupo B", "3º (E/F/G/I/J)")
        data[86] = MatchSchedule(86, "2026-07-03T22:00:00", "DAZN", "1º Grupo J", "2º Grupo H")
        data[87] = MatchSchedule(87, "2026-07-04T02:30:00", "DAZN", "1º Grupo K", "3º (D/E/I/J/L)")
        data[88] = MatchSchedule(88, "2026-07-03T19:00:00", "RTVE", "2º Grupo D", "2º Grupo G")
